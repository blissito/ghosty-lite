...
/// Opt-in via `GHOSTY_CLI_BELL=true` (environment or config); terminals
...
fn bell_enabled() -> bool {
    Config::global()
        .get_param::<bool>("GHOSTY_CLI_BELL")
        .unwrap_or(false)
}
...
mod tests {
    ...
    fn tool_confirmation_renders_authoritative_details_on_stderr() {
        const CHILD_ENV: &str = "GHOSTY_TEST_TOOL_CONFIRMATION_STDERR_CHILD";
