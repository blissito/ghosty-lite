...
pub const OPENAI_LIVE_VOICE_GATE_ENV: &str = "GHOSTY_LIVE_VOICE_ENABLED";
pub const OPENAI_LIVE_MODEL_ENV: &str = "GHOSTY_LIVE_VOICE_MODEL";
pub const OPENAI_LIVE_VOICE_ENV: &str = "GHOSTY_LIVE_VOICE";
