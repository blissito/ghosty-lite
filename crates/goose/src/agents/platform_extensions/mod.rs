    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Todo",
                description:
                    "Enable a todo list for ghosty so it can keep track of what it is doing",
                default_enabled: true,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Ghosty will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                hidden: false,
                client_factory: |ctx| {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Inject custom context into every turn via GHOSTY_MOIM_MESSAGE_TEXT and GHOSTY_MOIM_MESSAGE_FILE environment variables",
                default_enabled: true,
                unprefixed_tools: false,
                hidden: false,
