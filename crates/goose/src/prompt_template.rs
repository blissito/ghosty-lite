...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines ghosty's personality and behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new Ghosty apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing Ghosty apps based on feedback",
    ),
    (
        "permission_judge.md",
    ...
    (
        "plan.md",
        "Prompt used when ghosty creates step-by-step plans. CLI only",
    ),
    (
