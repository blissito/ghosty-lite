...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates ghosty's
...
Ghosty discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run ghosty normally; you should see lines like
